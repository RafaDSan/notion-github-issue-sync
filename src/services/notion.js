...
export const updateStatus = async (issue) => {
    try {
        ...
        //         }
        //     });
            console.log(`Updated existing record for issue #${issue.number} with new status: ${newStatus}`);
        // } else {
        //     console.log(`No update needed for issue #${issue.number} - status unchanged`);
        // }
    } catch (error) {
